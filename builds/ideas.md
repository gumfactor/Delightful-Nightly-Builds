...
| 13 | 2026-06-20 | I | ambitious | Weekly Project Dashboard / Context Switcher | Browser-based tool (HTML/JS, localStorage) to set weekly priorities across active projects (lab, Canada List, investments, personal), mark items complete, and export a weekly review summary. Directly addresses the managing-many-simultaneous-projects friction. | — | — | — | pending |
| 14 | 2026-06-20 | I | ambitious | Student Supervision Log | Python CLI + HTML report to log grad student and RA supervision sessions — meeting date, agenda, action items, deadlines — with a weekly "who needs follow-up?" view. Designed for a lab director managing 3–6 students simultaneously. | — | — | — | pending |
