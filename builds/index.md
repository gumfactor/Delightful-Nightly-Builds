...
- 2026-06-11 — [A] — focused — GitHub Repository Health Dashboard (complete)
...
| 2026-06-11 | A | focused | GitHub Repository Health Dashboard | Python CLI using GITHUB_TOKEN that fetches all your repos and renders a terminal table showing open issues, days since last push, and health status (active/quiet/stale/archived) sorted by most recent activity | Python 3, stdlib, pytest | complete | — | — |
