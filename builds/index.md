...
- **Aborted:** 0
- **Discarded:** 3
- **Last build date:** 2026-06-16
- **Categories used (all time):** A, B, C, D, E, F, H
...
- 2026-06-15 — [D] — focused — Vignette Lab (complete)
- 2026-06-16 — [E] — ambitious — Spaced Repetition Flashcards (complete)
...
| 2026-06-15 | D | focused | Vignette Lab | Python CLI that combinatorially generates psychological scenario vignettes (stress, empathy, moral) from element banks — outputs participant and researcher markdown files with manipulation checks | Python 3, stdlib, pytest | complete | — | — |
| 2026-06-16 | E | ambitious | Spaced Repetition Flashcards | Single-file browser app implementing the SM-2 spaced repetition algorithm with 50 pre-built flashcards across three decks: Bayesian Statistics (20 cards), Python Research Patterns (15), and Git & GitHub Workflows (15) | Vanilla HTML/CSS/JS, localStorage, Playwright | complete | — | — |
