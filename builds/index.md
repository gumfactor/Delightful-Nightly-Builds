...
- 2026-06-12 — [A] — solid — Investment Watchlist Dashboard (complete)
...
| 2026-06-12 | A | solid | Investment Watchlist Dashboard | Python script that fetches live Yahoo Finance data for a configurable watchlist and renders a self-contained HTML dashboard with prices, daily changes, 52-week range bars, market cap, P/E, and analyst targets | Python 3, yfinance, pytest | complete | — | — |
