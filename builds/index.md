...
- 2026-06-25 — [E] — ambitious — Stats Coach (complete)
...
| 2026-06-25 | E | ambitious | Stats Coach | Flask web app that guides researchers and students through choosing the right statistical test — interactive design form, decision tree covering 15 tests, Anthropic API explanation tailored to the design, R and Python code snippets, interpretation guide, SQLite response cache | Python 3, Flask, Anthropic API, SQLite, pytest | complete | — | — |
